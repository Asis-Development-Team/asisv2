                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet">
                                            <div class="portlet-title">
                                                ...
                                                <div class="caption">
                                                    <i class="fa fa-databasex"></i>Data Member (<span class="total-entry"><?php print $total; ?></span>) 
                                                </div>
                                                ...
                                                <div class="table-scrollable">
                                                    <table class="table table-striped table-bordered table-advance table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-center">
                                                                    <i class=""></i> Surname</th>

                                                                <th class="text-center">
                                                                    <i class=""></i> Email</th>
                                                                
                                                                <th class="hidden-xs text-center">
                                                                    <i class=""></i> Date Register 
                                                                </th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                            <tr class="parent-<?=$result['user_id']?> counter">


                                                                <td class="center">
                                                                    <input type="checkbox" class="checkboxes checkbox-delete" value="<?php print $result['user_id'] ?>" id="checkbox-delete-<?php print $result['user_id'] ?>" name="multichecked[]" />
                                                                </td>

                                                                <td>
                                                                    <?php print $result['surname']; ?>
                                                                </td>

                                                         
                                                                <td>
                                                                    <?php print $result['email']; ?>
                                                                    
                                                                </td>
                                                                <td class="text-center">
                                                                    <?php print nice_date($result['date_register'],'d M Y'); ?>
                                                                </td>

                                                                <td class="text-center">
                                                                    <?php print $result['user_hp']; ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a class="hidden" data-target="#full-width-<?php print $result['user_id'] ?>" data-toggle="modal" data-container="body" data-placement="top" data-original-title="View Detail" class="tooltips"><i class="fa fa-eye"></i></a>


                                                                    <a href="/admin/data/member/edit/?id=<?php print $result['user_id'] ?>" data-container="body" data-placement="top" data-original-title="Edit" class="tooltips"><i class="fa fa-edit"></i></a>
                                                                    <a href="javascript:;" class="delete-single tooltips" data-type="<?php print $page_identifier ?>" data-container="body" data-placement="top" data-original-title="Delete" data-id="<?php print $result['user_id'] ?>" id="delete-product-<?php print $result['user_id'] ?>"><i class="fa  fa-trash-o"></i></a>
                                                                    </div>                                                                    
                                                                ...
                                                                <tr class="modal" id="">
                                                                    <td colspan="7">
                                                                        ...
                                                                        <div id="full-payment-<?php print $result['user_id'] ?>" class="modal container fade" tabindex="-1">
