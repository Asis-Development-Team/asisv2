                                ...
                                <div class="portlet-body">
		                                    ...
		                                    <div class="btn-group">
		                                        ...
		                                        <ul class="dropdown-menu">
		                                            <li>
		                                                <a href="/data/<?php print $this->uri->segment('2') ?>/?q=<?php print @$_GET['q'] ?>&cabang=<?php print @$_GET['cabang'] ?>&show=20"> 20 </a>
		                                            </li>
		                                            <li>
		                                                <a href="/data/<?php print $this->uri->segment('2') ?>/?q=<?php print @$_GET['q'] ?>&cabang=<?php print @$_GET['cabang'] ?>&show=50"> 50 </a>
		                                            </li>
		                                            <li>
		                                                <a href="/data/<?php print $this->uri->segment('2') ?>/?q=<?php print @$_GET['q'] ?>&cabang=<?php print @$_GET['cabang'] ?>&show=100"> 100 </a>
		                                            </li>
		                                        </ul>
		                                    </div>
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table table-striped table-bordered table-advance table-hover">
                                            ...
                                            <tbody>
                                            	...
                                            	?>
                                                <tr class="parent-<?php print $result['rekening_id'] ?> counter">
                                                    
                                                    <td class="center hide-if-mobile">
                                                        <input type="checkbox" class="checkboxes checkbox-delete" value="<?php print $result['rekening_id'] ?>" id="checkbox-delete-<?php //print $result['product_id'] ?>" name="multichecked[]" />
                                                    </td>

                                                    <td class="">
                                                    	
	                                                    <div class="text-center">
	                                                    <a href="/<?php print $this->uri->segment('1') ?>/<?php print $page_url ?>-form/?id=<?php print $result['rekening_id'] ?>" data-container="body" data-placement="top" data-original-title="Edit" class="tooltips"><i class="fa fa-edit"></i></a>
                                                        
                                                        <a href="javascript:;" class="delete-single-baru" data-id="<?php print $result['rekening_id'] ?>" data-controller="<?php print $this->uri->segment('1') ?>" data-page="<?php print $page_identifier ?>" data-field="rekening_id" data-container="body" data-placement="top" data-original-title="Delete" class="tooltips">
                                                    ...
                                                    <td class="text-center"><span class=""><?php print $result['rekening_kode'] ?></span></td>       
                                                    <td class="text-left"><?php print $result['rekening_nama'] ?></td>
                                                    <td class="text-center"><?php print $result['klasifikasi_akun'] ?></td> 
                                                    <td class="text-center"><?php print $result['sub_klasifikasi_akun'] ?></td> 

                                                    <td class="text-center"><?php print $result['rekening_aktifasi'] ?></td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <button type="button" class="btn btn-danger btn-delete-checkbox-baru hide-if-mobile" data-controller="<?php print $this->uri->segment('1') ?>" data-page="<?php print $page_identifier ?>" data-field="rekening_id"><i class="icon-trash"></i> Delete Selected</button>
                                             </div>
