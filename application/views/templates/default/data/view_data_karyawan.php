                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table table-striped table-bordered table-advance table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="2%" class="hide-if-mobile hide-from-user"> </th>
                                                	

                                                	<th scope="col" <?php /* style="width:60px !important" width="15%" */ ?>></th>

                                                    <th scope="col"  width="30%"> <strong>Nama</strong> </th>
                                                    <th scope="col" class="text-center"> <strong>Telepon</strong> </th>
                                                    <th scope="col" class="text-center"> <strong>Jabatan</strong> </th>
                                            ...
                                            <tbody>
                                            	...
                                            	?>
                                                <tr class="parent-<?php print $result['karyawan_id'] ?> counter">
                                                    
                                                    <td class="center hide-if-mobile hide-from-user">
                                                        <input type="checkbox" class="checkboxes checkbox-delete" value="<?php print $result['karyawan_id'] ?>" id="checkbox-delete-<?php print $result['karyawan_id'] ?>" name="multichecked[]" />
                                                    </td>

                                                    <td class="">
                                                    	
	                                                    <div class="text-center">
	                                                    <a href="/<?php print $this->uri->segment('1') ?>/<?php print $page_url ?>-form/?id=<?php print $result['karyawan_id'] ?>" data-container="body" data-placement="top" data-original-title="Edit" class="tooltips"><i class="fa fa-edit"></i></a>
	                                                    
                                                        <a href="javascript:;" class="delete-single-baru" data-id="<?php print $result['karyawan_id'] ?>" data-controller="<?php print $this->uri->segment('1') ?>" data-page="<?php print $page_identifier ?>" data-field="karyawan_id" data-container="body" data-placement="top" data-original-title="Delete" class="tooltips">
                                                    ...
                                                    <td class="text-left"><span class=""><?php print stripslashes($result['karyawan_nama']) ?></span></td>       
                                                    <td class="text-left"><?php print $result['karyawan_hp'] ?></td>
                                                    <td class="text-left"><?php print $result['karyawan_jabatan'] ?></td> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <button type="button" class="btn btn-danger btn-delete-checkbox-baru hide-if-mobile hide-from-user" data-controller="<?php print $this->uri->segment('1') ?>" data-page="<?php print $page_identifier ?>" data-field="karyawan_id"><i class="icon-trash"></i> Delete Selected</button>
                                             </div>
