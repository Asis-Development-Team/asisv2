                                    ...
                                    <div class="table-scrollable">
                                        <table class="table table-striped table-bordered table-advance table-hover">
                                            ...
                                            <tbody>
                                            	...
                                            	?>
                                                <tr class="parent-<?php print $result['hutang_id'] ?> counter">
                                                    
                                                    <td class="center hide-if-mobile hidden">
                                                        <input type="checkbox" class="checkboxes checkbox-delete" value="<?php print $result['hutang_id'] ?>" id="checkbox-delete-<?php print $result['hutang_id'] ?>" name="multichecked[]" />
                                                    </td>

                                                    <td class="">
                                                    	
	                                                    <div class="text-center">
                                                            <a href="javascript:;"  class="tooltips" data-id="<?php print $result['hutang_id'] ?>" data-container="body" data-placement="top" data-original-title="Lihat Detail" data-target="#detail-po-<?php print $result['hutang_id'] ?>" data-toggle="modal">
                                                    ...
                                                    <td class="text-center"><span class=""><?php print stripslashes($result['supplier_nama']) ?></span></td>       
                                                    <td class="text-center"><?php print $this->tools->format_angka($result['hutang_jumlah_total'],0) ?></td>
                                                    <td class="text-center"><?php print $this->tools->format_angka($result['hutang_terbayar_total'],0) ?></td> 
                                                    <td class="text-center"><?php print $this->tools->format_angka($result['hutang_saldo_total'],0) ?></td> 
                                                ...
                                                <div id="detail-po-<?php print $result['hutang_id'] ?>" class="modal container" tabindex="-1" data-backdrop="static">
                                                    ...
                                                    <div class="modal-header">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="col-md-4">:                                                                                                                                   
                                                                    <?php print $result['supplier_nama'] ?>
                                                                </div>
