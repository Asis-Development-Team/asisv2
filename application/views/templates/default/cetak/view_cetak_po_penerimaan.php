<html>
    <title>Cetak Bukti Penerimaan Produk</title>
    <style>
        #tss{
            font-size: 10px;
    ...
    <body style="font-size: 11px">
            ...
            <tr>
                <td colspan="3" width='75%' class="bdr_btm">   
                ...
                <td class="bdr_btm">                    
                    <table width="100%">
                        <tr>
                            <td colspan="4">
                                <b>BUKTI PENERIMAAN PRODUK</b> 
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">ID Penerimaan</td>
                            <td>: <?php print $result['penerimaan_no_penerimaan'] ?></td>
                        </tr>
                        <tr>
                            <td width="30%">No Surat Jalan</td>
                            <td>: <?php print $result['penerimaan_no_surat_jalan'] ?></td>
                        </tr>
                        <tr>
                            <td>Tanggal </td>
                            <td>: <?php print $this->tools->tanggal_indonesia($result['penerimaan_tanggal']); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="4" class="bdr_btm">
                    <table width='100%'>
                        ...
                        <tr>
                            <td><?php print $no; ?></td>
                            <td><?php print $detail['penerimaan_detail_product_kode'] ?></td>
                            <td><?php print $detail['penerimaan_detail_product_nama'] ?></td>
                            <td><?php print $detail['penerimaan_detail_jumlah'] ?></td>
                            <td align='right'><?php print $this->tools->format_angka($detail['penerimaan_detail_harga'],0) ?></td>
                            <td align='right'><?php print $this->tools->format_angka($detail['penerimaan_detail_total'],0); ?></td>
                        </tr>
                        <?php 
                            $no++;

                            $total  +=  $detail['penerimaan_detail_total'];  
                    ...
                    <table width='90%' align='center'>
                        <tr>
                            <td width='33.3%' align='center'>                                
                                Di Buat Oleh,
                                <br/><br/><br/><br/><br/>
                                <?php print $this->session->sess_surname; ?>                            
                                </td>
                            <td width='33.3%' align='center'>
                            </td>
                            <td width='33.3%' align='center'>
