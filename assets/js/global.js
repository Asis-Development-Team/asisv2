    ...
    rangeSlider: function(){
		if( $rangeSliderEl.length > 0 ) {
          ...
          element.slider().on('slideStop', function(ev){
                ...
                //alert(ev.value[0] + ' -- ' + ev.value['1']);

                //window.location = ev.value[0];
			    ...
			    var uri = '?q=' + q + '&category=' + category + '&page=' + page + '&sort=' + sort + '&show=' + show + '&status=' + status;

				setTimeout(
				function() 
				{
					window.location =  uri + '&low=' + ev.value[0] + '&high=' + ev.value[1];
